...
//			boolean hasParent = getExpandableOf(position) != null;
//			if ((isExpandable(position) || !hasParent) && !childSelected) {
...
//	}
	...
	public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
	    if (isHeader(position)) {
	        ...
	        this.onBindViewHolder(holder, position, isSelected(position));
	    }
	}

	protected abstract void onBindViewHolder(ViewHolder holder, int position, boolean selected);
...
//        if (isHeader(oldPos)) {
//            if (stickyHeaderDecoration != null) {
//                stickyHeaderDecoration.removeFromCache(holder, oldPos);
//            }
//        }
//	    
//	}
...
//			Log.v(TAG, "moveItem beforeSwap fromItem=" + fromPosition + " toItem=" + toPosition);
//		}
//	      if (headersShown && ) {
//	      }
//		//Perform item swap
...
//		if (DEBUG) {
//			Log.v(TAG, "moveItem afterSwap fromItem=" + fromPosition + " toItem=" + toPosition);
//		}
