...
public abstract class FlexibleExpandableAdapter2<EVH extends ExpandableViewHolder, T extends IExpandableItem<T>>
		extends FlexibleAdapter<FlexibleViewHolder, T> {

	private static final String TAG = FlexibleExpandableAdapter2.class.getSimpleName();
	...
	public FlexibleExpandableAdapter2(@NonNull List<T> items) {
		this(items, null);
	}

	public FlexibleExpandableAdapter2(@NonNull List<T> items, Object listener) {
