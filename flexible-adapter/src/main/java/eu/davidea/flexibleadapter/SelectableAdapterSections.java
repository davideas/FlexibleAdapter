...
public abstract class SelectableAdapterSections extends RecyclerView.Adapter
		implements FastScroller.BubbleTextCreator, FastScroller.ScrollStateChangeListener {

	private static final String TAG = SelectableAdapterSections.class.getSimpleName();
...
//	private EnumSet<Mode> mode = EnumSet.of(Mode.IDLE);
	...
	public SelectableAdapterSections() {
