...
public class SlideInLeftItemAnimator extends FlexibleItemAnimator {

    public SlideInLeftItemAnimator() {
    }

    public SlideInLeftItemAnimator(Interpolator interpolator) {
