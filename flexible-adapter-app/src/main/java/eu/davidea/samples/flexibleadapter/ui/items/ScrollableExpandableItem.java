package eu.davidea.samples.flexibleadapter.ui.items;
...
import eu.davidea.samples.flexibleadapter.ui.items.ScrollableExpandableItem.ScrollableExpandableViewHolder;
